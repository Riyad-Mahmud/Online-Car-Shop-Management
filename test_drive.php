...
<h3 style="text-align:center;margin-bottom:40px;">Please Enter Details To Drive <?php echo "$post_new_id"; ?></h3>


<form method="post" action="test_drive.php?post=<?php echo $post_id; ?>">
  <table width="600" height="450" align="center" bgcolor="#ADD8E6" >
   ...
   <tr>
    ...
    <tr>
       ...
       <tr>
           <td class="label" align="center" colspan="2"><input type="submit" name="submit" value="Submit" style="height: 30px;width: 60px;"></td>
